...
def fit_multi_ic_rpinn(cfg, y_data_all, t_obs, t_plot, N_grid, n_ics, device):
    ...
    lambda_g0 = getattr(cfg, "lambda_g0", 1.0)
    ...
    def _train_single_run(
        ...
        for epoch in range(cfg.n_epochs_pinn):
            ...
            for ic_idx in range(n_ics):
                ...
                g0_loss = g_zero_nonnegative_penalty(dyn_net, device)
            ...
            train_g0_history.append(total_g0_loss.item())
            ...
            if (epoch == 0) or ((epoch + 1) % cfg.print_every_pinn == 0) or (epoch == cfg.n_epochs_pinn - 1):
                print(
                    ...
                    f"G0={total_g0_loss.item():.6e} | IC={total_ic_loss.item():.6e}"
                )
        ...
        return {
            ...
            "train_g0_history": train_g0_history,
    ...
    for sample_idx in range(cfg.n_rpinn_samples):
        ...
        train_g0_histories.append(result["train_g0_history"])
    ...
    return {
        ...
        "map_train_g0_history": np.array(map_result["train_g0_history"]),
        ...
        "train_g0_histories": train_g0_histories,
