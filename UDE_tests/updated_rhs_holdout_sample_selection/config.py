...
class ExperimentConfig:
    ...
    # Holdout-based checkpointing / sample selection for rPINN
    val_fraction_rpinn: float = 0.2
    val_split_seed: int = 31415
    select_by_holdout: bool = True
    n_selected_samples: int = 0  # 0 means keep all posterior samples
